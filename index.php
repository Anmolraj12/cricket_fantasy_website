<html>
    ...
    <body>
    <div id="mainimg">
        <div id="logo">Cricket Fantasy</div>
        <input id="login" class="gobutton" type="button" value="LOG IN" onclick="homelog()" style="width:auto">
        <input id="register" class="gobutton" type="button" value="Register & play" onclick="homereg()">
      <input id="Payment" class="gobutton" type="button" value="Payment" onclick="homereg1()">
    ...
    <div class="howtoplay">
        <h1>How to Play</h1>
        <hr>
        <h3 class="sub">1.Select the match<br>2.Create you Cricket Fantasy team<br>3.Score points and win cool prizes</h3>
    ...
    <div id="homelogin" class="modal">
          ...
          <div id="homereg1" class="modal">
                <form class="modal-content animate" action="register.php" method="post" name="registration_form" onsubmit="return validateform()">
                <div class="closecontainer"> 
                      <span onclick="closereg1()" class="close" title="Close Modal">&times;</span>
                    </div>
                  <div class="container">
                    <h1>Name</h1>
                    <p>Please fill in this form to complete payment.</p>
                    <hr>
                    <label for="uname"><b>Username</b></label>
                    <input type="text" placeholder="Enter username" name="uname" required>
                    ...
                    <input type="password" placeholder="Enter Number" name="password" required>
                    ...
                    <div class="clearfix">
                      <button type="button" onclick="clearreg1()" class="cancel2btn">Cancel</button>
                      <button type="submit" class="signupbtn" name="submit_register">PAY NOW</button>
                    </div>
                  </div>
                </form>
              </div>
